...
LOGIN_SERIALIZER_PATH = "be_skeleton_test.apps.accounts.api.v1.serializers.login.LoginSerializer"
...
def test_login_api_success(user_account, unauthorized_api_client, mocker):
    ...
    mocked_login = mocker.patch(
        "be_skeleton_test.apps.accounts.services.login.LoginService.login", return_value=mocked_response
    )
